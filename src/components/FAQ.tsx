...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Your physical safety comes first — always. This programme is designed for those who are out of immediate danger but still carrying the impacts in their body and nervous system. If you are currently in an unsafe situation, please contact your local domestic violence services or call 999. Lisa can provide referrals to crisis support organisations.',
  },
  {
    question: 'Do you offer payment support or sliding scale pricing?',
    answer:
      'Yes. Payment plans are available for all tiers, and a sliding scale is offered for those experiencing financial hardship. Your healing should not be limited by your financial situation. Contact Lisa directly and privately to discuss what would work for you — without any pressure.',
  },
];
