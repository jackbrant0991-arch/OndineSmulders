                                ...
                                {step === 2 && !submitted && (
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-slate/50 mb-8">
                                            This helps Lisa understand your starting point — no right or wrong answers.
                                        </p>
                                        ...
                                        <div className="mb-8">
                                            <label htmlFor="modal-message" className="block text-sm font-medium text-slate mb-1.5">
                                                Is there anything you'd like Lisa to know before she reaches out?{' '}
                                ...
                                {submitted && (
                                    ...
                                    >
                                        ...
                                        <p className="text-slate/65 mb-6" style={{ lineHeight: '1.8' }}>
                                            Lisa will be in touch within 48 hours — privately and without pressure.
                                        </p>
